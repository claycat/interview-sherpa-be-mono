...
@PersistenceAdapter
public class CommentPersistenceAdapter implements PostCommentPort, GetCommentsQueryPort {
	...
	@Override
	@Transactional
	public Comment saveComment(String content, UUID memberId, UUID parentId, UUID nodeId) {
		...
		var commentJpaEntity = new CommentJpaEntity(content, nodeId);
